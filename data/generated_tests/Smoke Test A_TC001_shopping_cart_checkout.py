...
async def test_tc001():
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            await page.wait_for_load_state('networkidle')
            await page.wait_for_timeout(500)
            print("Step 4: Input 'John' into First Name field using selector: input[data-test='firstName']")
            # Input text
            await page.locator('input[data-test='firstName']').first.fill("Test")
            await page.wait_for_timeout(200)
            print("Step 5: Input 'Doe' into Last Name field using selector: input[data-test='lastName']")
            # Input text
